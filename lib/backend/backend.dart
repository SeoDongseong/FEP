...
import 'schema/sent_wage_record.dart';
...
export 'schema/sent_wage_record.dart';
...
/// Functions to query SentWageRecords (as a Stream and as a Future).
Stream<List<SentWageRecord>> querySentWageRecord({
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SentWageRecord.collection,
...
Future<List<SentWageRecord>> querySentWageRecordOnce({
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<SentWageRecord>> querySentWageRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
