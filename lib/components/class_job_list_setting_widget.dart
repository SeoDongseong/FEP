                        ...
                        child: Builder(
                          builder: (context) {
                            ...
                            return ListView.builder(
                              ...
                              itemCount: jobListView.length,
                              itemBuilder: (context, jobListViewIndex) {
                                final jobListViewItem =
                                    jobListView[jobListViewIndex];
                                return Container(
                                  width:
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        FlutterFlowIconButton(
                                          ...
                                          onPressed: () async {
                                            isEssentialJobResult = await actions
                                                .isThisEssentialJob(
