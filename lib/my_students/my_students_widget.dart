...
import '../components/basic_wage_send_pop_widget.dart';
      ...
      child: StreamBuilder<List<StudentsRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          return Scaffold(
            ...
            floatingActionButton: StreamBuilder<List<ClassSettingRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                List<ClassSettingRecord>
                    floatingActionButtonClassSettingRecordList = snapshot.data;
                // Return an empty Container when the document does not exist.
                if (snapshot.data.isEmpty) {
                  return Container();
                }
                final floatingActionButtonClassSettingRecord =
                    floatingActionButtonClassSettingRecordList.isNotEmpty
                        ? floatingActionButtonClassSettingRecordList.first
                        : null;
                      ...
                      await showModalBottomSheet(
                        ...
                        builder: (context) {
                          return Padding(
                            ...
                            child: BasicWageSendPopWidget(
                              classSettingRef:
                                  floatingActionButtonClassSettingRecord
                                      .reference,
                            ),
                          );
                        },
